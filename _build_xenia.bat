...
"%~dp0dependencies/arkhelper" dir2ark "%~dp0_ark" "%~dp0_build\xbox\gen" -n "patch_xbox" -e -v 6
...
rd _temp
echo:
if %FAILED_ARK_BUILD% neq 1 (echo:Successfully built Rock Band 3 Deluxe ARK.)
...
rem if %FAILED_ARK_BUILD% neq 1 (echo:Launching Xenia &"%~dp0\_xenia\xenia_canary" "%~dp0\_build\xbox\default_xenia.xex")
echo:
